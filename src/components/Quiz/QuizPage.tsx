...
export default function QuizPage(): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm py-3 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto flex flex-col gap-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <button
                onClick={() => navigate(-1)}
                aria-label="Go back"
                className="p-2 rounded-full hover:bg-gray-100 transition focus:outline-none focus:ring-2 focus:ring-indigo-200"
                type="button"
              >
          ...
          {/* Progress Bar directly in header */}
        ...
        <AnimatePresence>
          {showNav && (
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-md p-3 mb-4 overflow-hidden"
            >
