...
import { Menu, BookOpen, Bell, Search, User, ChevronDown } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          >
            <div className={`
              ...
              ${isHoveringLogo ? 'rotate-6 scale-110' : ''}
            `}>
              <BookOpen size={24} className="transition-transform duration-300 group-hover:scale-110" />
            </div>
            <h1 className={`
